  ...
  return (
    <div className="mb-16 px-16">
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 justify-items-center gap-8 my-10">
        <div class="card card-compact w-52 bg-base-100 ">
          <figure>
            <FlagIcon className="h-24 w-24 text-primary" />
          </figure>
          <div class="text-center">
            <h2 class="text-4xl font-bold text-accent">65+</h2>
        ...
        <div class="card card-compact w-52 bg-base-100 ">
          ...
          <div class="text-center">
            <h2 class="text-4xl font-bold text-accent">1200+</h2>
        ...
        <div class="card card-compact w-52 bg-base-100 ">
          ...
          <div class="text-center">
            <h2 class="text-4xl font-bold text-accent">255+</h2>
        ...
        <div class="card card-compact w-52 bg-base-100 ">
          ...
          <div class="text-center">
            <h2 class="text-4xl font-bold text-accent">343+</h2>
